                ...
                BlocBuilder<UserBloc, UserState>(
                  ...
                  builder: (context, state) {
                    return _LoveLanguageChipsWrap(
                      ...
                      onSelected: (index) {
                        context.read<UserBloc>().changePref('love_lang', index);
                      },
                      onDeselected: () {
                        context.read<UserBloc>().changePref('love_lang', null);
                      },
                    );
                  },
                ),
                ...
                BlocBuilder<UserBloc, UserState>(
                  ...
                  builder: (context, state) {
                    return _NutritionChipsWrap(
                      ...
                      onSelected: (index) {
                        context.read<UserBloc>().changePref('nutrition', index);
                      },
                      onDeselected: () {
                        context.read<UserBloc>().changePref('nutrition', null);
                      },
                    );
                  },
                ),
                ...
                BlocBuilder<UserBloc, UserState>(
                  ...
                  builder: (context, state) {
                    return _PetsChipsWrap(
                      ...
                      onSelected: (index) {
                        context.read<UserBloc>().changePref('pets', index);
                      },
                      onDeselected: () {
                        context.read<UserBloc>().changePref('pets', null);
                      },
                    );
                  },
                ),
                ...
                BlocBuilder<UserBloc, UserState>(
                  ...
                  builder: (context, state) {
                    return _AlcoholChipsWrap(
                      ...
                      onSelected: (index) {
                        context.read<UserBloc>().changePref('alcohol', index);
                      },
                      onDeselected: () {
                        context.read<UserBloc>().changePref('alcohol', null);
                      },
                    );
                  },
                ),
                ...
                BlocBuilder<UserBloc, UserState>(
                  ...
                  builder: (context, state) {
                    return _SmokingChipsWrap(
                      ...
                      onSelected: (index) {
                        context.read<UserBloc>().changePref('smoking', index);
                      },
                      onDeselected: () {
                        context.read<UserBloc>().changePref('smoking', null);
                      },
                    );
                  },
                ),
                ...
                BlocBuilder<UserBloc, UserState>(
                  ...
                  builder: (context, state) {
                    return _EducationChipsWrap(
                      ...
                      onSelected: (index) {
                        context.read<UserBloc>().changePref('education', index);
                      },
                      onDeselected: () {
                        context.read<UserBloc>().changePref('education', null);
                      },
                    );
                  },
                ),
                ...
                BlocBuilder<UserBloc, UserState>(
                  ...
                  builder: (context, state) {
                    return _ChildrenChipsWrap(
                      ...
                      onSelected: (index) {
                        context.read<UserBloc>().changePref('children', index);
                      },
                      onDeselected: () {
                        context.read<UserBloc>().changePref('children', null);
                      },
                    );
                  },
                ),
                ...
                BlocBuilder<UserBloc, UserState>(
                  ...
                  builder: (context, state) {
                    return _WorkoutChipsWrap(
                      ...
                      onSelected: (index) {
                        context.read<UserBloc>().changePref('workout', index);
                      },
                      onDeselected: () {
                        context.read<UserBloc>().changePref('workout', null);
                      },
                    );
                  },
                ),
